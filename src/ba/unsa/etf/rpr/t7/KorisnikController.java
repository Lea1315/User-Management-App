...
public class KorisnikController {
    ...
    public void btnDelete(ActionEvent actionEvent) {
        if(model.getTrenutniKorisnik() != null) {
            ...
            model.deleteKorisnika();
        }
    }

    public void akcijaExit(ActionEvent actionEvent) {
        System.exit(0);
    }
    ...
    public void akcijaSave(ActionEvent actionEvent) {
        FileChooser izbornik = new FileChooser();
        izbornik.setTitle("Odaberite datoteku");
        izbornik.getExtensionFilters().add(new FileChooser.ExtensionFilter("Tekstualna datoteka", "*.txt"));
        model.zapisiDatoteku(izbornik.showSaveDialog(new Stage()));
    }
}
